...
<head>
  ...
  <link rel="icon" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'%3E%3Crect width='32' height='32' fill='%23F7C600'/%3E%3Cellipse cx='16' cy='34' rx='13' ry='9' fill='%23C82020'/%3E%3Ccircle cx='16' cy='14' r='10' fill='%23FAE4A0'/%3E%3Ccircle cx='16' cy='14' r='10' fill='none' stroke='%232D2820' stroke-width='1.2'/%3E%3Cellipse cx='11.5' cy='11.5' rx='1.5' ry='1' fill='none' stroke='%232D2820' stroke-width='1.2' stroke-linecap='round'/%3E%3Cellipse cx='20.5' cy='11.5' rx='1.5' ry='1' fill='none' stroke='%232D2820' stroke-width='1.2' stroke-linecap='round'/%3E%3Cpath d='M12 17.5 Q16 21 20 17.5' fill='none' stroke='%232D2820' stroke-width='1.3' stroke-linecap='round'/%3E%3C/svg%3E">
  <style>
    :root {
      --ink: #2D2820;
      --ink-deep: #1A1510;
    ...
    * {
    ...
    body {
      ...
      background-image:
        radial-gradient(circle at 8% 12%, rgba(247, 198, 0, 0.07) 0, transparent 40%),
        radial-gradient(circle at 92% 88%, rgba(200, 32, 32, 0.04) 0, transparent 45%);
    ...
    .property-img::before {
      ...
      inset: 0;
      background:
        repeating-linear-gradient(45deg, transparent 0, transparent 14px, rgba(232, 196, 104, .05) 14px, rgba(232, 196, 104, .05) 15px),
    ...
    .chat-toggle {
      ...
      cursor: pointer;
      z-index: 200;
      box-shadow: 0 6px 20px rgba(200, 72, 46, .4);
      transition: all .15s;
    }
    ...
    footer .brand .license {
      ...
      color: #7a7363;
      padding-top: 10px;
      border-top: 1px solid rgba(247, 198, 0, .2);
      margin-top: 14px;
    }
